...
Then create a `MyToken.ts` under `ignition/modules` and enter the following code
...
LockModule#Lock - 0x76F635e60b7f765C426c78D07a1ec9ac6752De13
```

## Interact with the contract

The tutorial will use ethers.js to interact with the smart contract
...
async function main() {
  ...
  const contract = new Contract("0xe5F54D19AA5c3c16ba70bC1E5112Fe37F1764134", abi, owner);
